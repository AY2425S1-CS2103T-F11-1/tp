...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withRemark("she likes aardvaaks").withTags("friends").build();
    public static final Person BENSON =
            new PersonBuilder().withName("Benson Meier").withAddress("311, Clementi Ave 2, #02-25")
                    .withEmail("johnd@example.com").withPhone("98765432").withRemark("weee woooo")
    ...
    public static final Person HOON =
            new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
